---
name: release
description: Ensure `APP_VERSION` in `core/domain/constants.js` matches the release branch, then commit, push, and open a PR with release notes. Use when the user asks to cut a release or run the old `/release` workflow.
---
