(function bootstrapCategoryDefaults(globalScope) {
  ...
  const defaults = {
    ...
    DEFAULT_CATEGORY_DEFS: [
      { id: 'featured_specials', icon: '⭐', color: palette[3], title: 'Featured Specials', sub: 'Limited pours, specials, and deal items', placeholder: 'e.g. Happy Hour Margarita...', untappdEnabled: false },
    ...
    DEFAULT_FOOD_CATEGORY_DEFS: [
      { key: 'featured_specials', label: '⭐ Featured Specials', icon: '⭐', color: palette[3], sub: 'Limited dishes and deal items', placeholder: 'e.g. Taco Tuesday Plate...', untappdEnabled: false },
